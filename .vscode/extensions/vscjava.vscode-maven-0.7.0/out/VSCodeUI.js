...
(function (VSCodeUI) {
    ...
    VSCodeUI.closeAllTerminals = closeAllTerminals;
    ...
    function setupEnvironment(terminal) {
        ...
        const environmentSettings = vscode_1.workspace.getConfiguration("maven").get("terminal.customEnv");
    ...
    function setJavaHomeIfAvailable(terminal) {
        ...
        const useJavaHome = vscode_1.workspace.getConfiguration("maven").get("terminal.useJavaHome");
    ...
    VSCodeUI.setJavaHomeIfAvailable = setJavaHomeIfAvailable;
    ...
    VSCodeUI.composeSetEnvironmentVariableCommand = composeSetEnvironmentVariableCommand;
